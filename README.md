# Dory
Digital Engineering assistant developed at UNSW Canberra with modular RAG, configurable embeddings, and a Streamlit UI. Supports DE and Summit queries with document-grounded answers.
